 ...
 * @author bhugo
 */
public class exercicisExempleAmbDecimal {
    public static void main(String[] args) {
        double[] numElements = new double[6];
    ...
    public static double[] generaVector(double[] numElements) {
        numElements[0] = 6;
        numElements[1] = 5;
        numElements[2] = 4;
        numElements[3] = 3;
    ...
    public static void ordenaSeleccio(double[] numElements) {
    ...
    public static void ordenaBombolla(double[] numElements) {
        double n = 0;
        for (int i = 0; i < numElements.length; i++) {
